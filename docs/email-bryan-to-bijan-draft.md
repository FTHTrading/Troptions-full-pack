...
Use placeholders below. Attach or link `docs/WHATS_BUILT_INVESTOR_ONE_PAGER.md` if sending as PDF/markdown export.
...
Use `frontends/exchange-os/docs/TROPTIONS-GENESIS-BUILD.md` as the genesis/system audit prompt (8 brands, L1, XRPL/Polygon/Solana layers, compliance gates). For day-to-day ops, `docs/RUNBOOK.md` and `scripts/bootstrap-dao.ps1` mirror what we run in production-style PM2 layouts.
...
- [ ] Clone repo and run `scripts/quickstart-all.ps1` (or `.sh` on Linux)
- [ ] Review `frontends/dao-dashboard/` via http://127.0.0.1:8093
- [ ] Read one-pager: `docs/WHATS_BUILT_INVESTOR_ONE_PAGER.md`
- [ ] Optional deep dive: `frontends/exchange-os/docs/TROPTIONS-GENESIS-BUILD.md`
