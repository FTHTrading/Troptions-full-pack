---
title: Full audit report (archived)
layout: default
permalink: /technical/archive/FULL_AUDIT_REPORT.html
---

> **Archived 2026-05-21.** Superseded by [FINAL_ECOSYSTEM_AUDIT.md](../FINAL_ECOSYSTEM_AUDIT.html).  
> Several claims below were wrong (e.g. only 2/9 repos cloned, all HTTP timeouts). Kept for history.
