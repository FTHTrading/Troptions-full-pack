...
export const metadata = {
  title: "DAI Route Profile | TROPTIONS Stablecoins",
  description: "DAI route profile for TROPTIONS - live-issued gateway IOU, DeFi-native USD settlement, and risk controls.",
};

const record = STABLECOIN_ISSUER_REGISTRY.find((r) => r.symbol === "DAI")!;

export default function TroptionsStablecoinsDaiPage() {
  return (
    <main className="te-page">
      <div className="te-wrap" style={{ gap: "1.5rem" }}>
        <div style={{ background: "rgba(5,46,22,0.2)", border: "1px solid rgba(22,101,52,0.45)", borderRadius: "0.65rem", padding: "0.65rem 0.9rem", display: "flex", gap: "0.5rem", alignItems: "flex-start" }}>
          ...
          <p style={{ margin: 0, fontSize: "0.78rem", color: "#86efac", lineHeight: 1.5 }}><strong>Live mainnet issuance confirmed.</strong> DAI gateway IOU is issued on XRPL + Stellar mainnet as of 2026-04-28. Verify issuer, trustline, and redemption path before acceptance.</p>
        </div>

        <div className="te-panel" style={{ padding: "1.75rem" }}>
          <div style={{ display: "flex", alignItems: "flex-start", gap: "1rem", flexWrap: "wrap" }}>
            <Image src="/assets/troptions/logos/dai-iou-logo.svg" alt="DAI logo" width={72} height={72} style={{ borderRadius: "50%", border: "1px solid rgba(167,139,250,0.45)", flexShrink: 0 }} />
            <div style={{ flex: 1 }}>
              <p className="te-kicker">MakerDAO / Sky Protocol · DeFi-Native Stablecoin</p>
              <h1 className="te-heading">DAI Route Profile</h1>
              <p className="te-subheading" style={{ marginTop: "0.4rem", maxWidth: "620px" }}>DAI provides DeFi-native USD settlement with over-collateralized mechanics, plus AAVE-aligned collateral and yield workflows for programmable deal structures.</p>
              <div style={{ display: "flex", flexWrap: "wrap", gap: "0.45rem", marginTop: "0.9rem" }}>
                ...
                <span style={{ background: "#1e0a4e", color: "#c4b5fd", border: "1px solid #4c1d95", borderRadius: "0.3rem", padding: "0.15rem 0.5rem", fontSize: "0.68rem", fontWeight: 700 }}>DEFI-NATIVE USD</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="te-panel" style={{ padding: "1.5rem" }}>
          ...
          <div style={{ display: "grid", gap: "0.6rem" }}>
            {[
              ...
              { label: "Default Route", value: "No - specialized DeFi settlement route" },
