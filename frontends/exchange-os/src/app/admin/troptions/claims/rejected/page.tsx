import { getRejectedClaims } from "@/content/troptions/claimRegistry";
...
const claims = getRejectedClaims();
      ...
      <div className="max-w-5xl mx-auto px-6 py-16 space-y-10">
        <div className="flex items-center justify-between">
          <div>
            ...
            <h1 className="text-3xl font-bold text-white">Rejected Claims</h1>
            <p className="text-slate-400 text-sm mt-1">
              {claims.length} claim(s) rejected. These must not be published in any form.
            </p>
          </div>
        ...
        {claims.length === 0 ? (
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-8 text-center text-slate-500">
            No claims are currently rejected.
          </div>
        ) : (
