...
Write-Host "  pm2 start ecosystem.config.js --only payment-orchestrator,fedwire-adapter,swift-bridge,compliance-engine,neobank-api,iou-reserve-monitor,baas-api"
Write-Host "  curl http://127.0.0.1:4022/health"
Write-Host "  curl http://127.0.0.1:8097/health"
Write-Host "  .\scripts\batch-create-pools.ps1 -DryRun"
